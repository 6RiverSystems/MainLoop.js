...
(function(root) {
	...
	function callUpdate(frameDelta) {

		if (frameDelta < simulationTimestep) {
			return Promise.resolve(frameDelta);
		}
		...
		return update(simulationTimestep)
		.then(function() {
			++numUpdateSteps;
			return callUpdate(frameDelta - simulationTimestep);
		});
	}
	...
	function animate(timestamp) {
		 ...
		 */
		numUpdateSteps = 0;
		callUpdate(frameDelta)
		.then(function(frameDelta) {
			/*
